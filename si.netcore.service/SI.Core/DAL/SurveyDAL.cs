...
namespace SystemIntegration_2018
{
    class SurveyDAL
    {
        ...
        //string dataSource = "Data Source=LAPTOP-AH4RCK16;Initial Catalog=SystemIntegrationDB;Connection Timeout=45;User ID=admin;Password=admin;";
        //using (var connection = new SqlConnection(dataSource))
        //{
        //    //using (SqlCommand cmd = new SqlCommand($"SELECT user_owner FROM dbo.Survey WHERE user_owner = @user_owner", connection))
        //    //{
        //    //    cmd.Parameters.AddWithValue("user_owner", "test");
        //    //    connection.Open();
        //    //    using (SqlDataReader reader = cmd.ExecuteReader())
        //    //    {
        //    //        // Check is the reader has any rows at all before starting to read.
        ...
        //    //            while (reader.Read())
        //    //            {
        //    //                Console.WriteLine(reader.GetString(reader.GetOrdinal("user_owner")));
